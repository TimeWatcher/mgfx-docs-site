...
features:
  - title: 先选运行时
    details: 普通 GMod addon include mgfx/init.lua，并局部保存返回的 API；Lux 项目导入 @lux/mgfx，使用 mgfx.api.*。
  ...
  - title: 对社区更友好的授权
    details: 满足条件的社区服务器可回收运营成本，并允许在 Community License 1.1 下开发免费插件。
---
...
<div class="mgfx-capability-grid">
  <a href="./guide/glua">
    ...
    <small>include mgfx/init.lua，并把返回的 PascalCase API 表保存在当前 addon 内。</small>
  </a>
  <a href="./guide/lux">
    <span>Lux</span>
